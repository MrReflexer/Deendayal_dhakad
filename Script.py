...
ɪ ᴀᴍ ᴍᴏsᴛ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏ ꜰɪʟʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ ᴘʀᴇᴍɪᴜᴍ ꜰᴇᴀᴛᴜʀᴇs.
ᴊᴜsᴛ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ᴏꜰ ʏᴏᴜʀ ɢʀᴏᴜᴘ. 

ᴍᴀɪɴᴛᴀɪɴᴇᴅ ᴀɴᴅ ᴅᴇᴠʟᴏᴘᴇᴅ ʙʏ : <a href="https://t.me/Mr_Reflexer">Mʀ. ʀᴇꜰʟᴇxᴇʀ ~ 🇮🇳</b>"""
...
📜 ᴘʀɪᴠᴀᴄʏ ᴘᴏʟɪᴄʏ : <a href='https://graph.org/Privacy-Policy-02-06-57'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a>
</b>"""
...
• /batch - ᴄʀᴇᴀᴛᴇ ᴀ ʙᴀᴛᴄʜ ʟɪɴᴋ ᴏꜰ ᴍᴜʟᴛɪᴘʟᴇ ꜰɪʟᴇs.
• /link - ᴄʀᴇᴀᴛᴇ ᴀ sɪɴɢʟᴇ ꜰɪʟᴇ sᴛᴏʀᴇ ʟɪɴᴋ.
• /pbatch - ᴊᴜsᴛ ʟɪᴋᴇ <code>/batch</code>, ʙᴜᴛ ᴛʜᴇ ꜰɪʟᴇs ᴡɪʟʟ ʙᴇ sᴇɴᴅ ᴡɪᴛʜ ꜰᴏʀᴡᴀʀᴅ ʀᴇsᴛʀɪᴄᴛɪᴏɴs.
• /plink - ᴊᴜsᴛ ʟɪᴋᴇ <code>/link</code>, ʙᴜᴛ ᴛʜᴇ ꜰɪʟᴇ ᴡɪʟʟ ʙᴇ sᴇɴᴅ ᴡɪᴛʜ ꜰᴏʀᴡᴀʀᴅ ʀᴇsᴛʀɪᴄᴛɪᴏɴ.
...
• /system - <code>sʏsᴛᴇᴍ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ </code>
• /del_msg - <code>ʀᴇᴍᴏᴠᴇ ꜰɪʟᴇ ɴᴀᴍᴇ ᴄᴏʟʟᴇᴄᴛɪᴏɴ ɴᴏᴛɪꜰɪᴄᴀᴛɪᴏɴ...</code> 
• /movie_update - <code>ᴏɴ ᴏꜰꜰ ᴀᴄᴄᴏʀᴅɪɴɢ ʏᴏᴜʀ ɴᴇᴇᴅᴇᴅ...</code> 
• /pm_search - <code>ᴘᴍ sᴇᴀʀᴄʜ ᴏɴ ᴏꜰꜰ ᴀᴄᴄᴏʀᴅɪɴɢ ʏᴏᴜʀ ɴᴇᴇᴅᴇᴅ...</code>
...
• /gfilter - <code>ᴀᴅᴅ ɢʟᴏʙᴀʟ ꜰɪʟᴛᴇʀs.</code>
• /gfilters - <code>ᴠɪᴇᴡ ʟɪsᴛ ᴏꜰ ᴀʟʟ ɢʟᴏʙᴀʟ ꜰɪʟᴛᴇʀs.</code>
• /delg - <code>ᴅᴇʟᴇᴛᴇ ᴀ sᴘᴇᴄɪꜰɪᴄ ɢʟᴏʙᴀʟ ꜰɪʟᴛᴇʀ.</code>
• /delallg - <code>ᴅᴇʟᴇᴛᴇ ᴀʟʟ Gꜰɪʟᴛᴇʀs ꜰʀᴏᴍ ᴛʜᴇ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ.</code>
• /deletefiles - <code>ᴅᴇʟᴇᴛᴇ CᴀᴍRɪᴘ ᴀɴᴅ PʀᴇDVD ꜰɪʟᴇs ꜰʀᴏᴍ ᴛʜᴇ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ.</code>
...
<b>𝐏𝐋𝐄𝐀𝐒𝐄 𝐃𝐎𝐍𝐀𝐓𝐄 𝐓𝐇𝐄 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 𝐅𝐎𝐑 𝐊𝐄𝐄𝐏𝐈𝐍𝐆 𝐓𝐇𝐄 𝐒𝐄𝐑𝐕𝐈𝐂𝐄 𝐀𝐋𝐈𝐕𝐄 & 𝐊𝐄𝐄𝐏 𝐁𝐑𝐈𝐍𝐆𝐈𝐍𝐆 𝐌𝐎𝐑𝐄 𝐍𝐄𝐖 𝐅𝐄𝐀𝐓𝐔𝐑𝐄𝐒 𝐅𝐎𝐑 𝐘𝐎𝐔.𝐈𝐓 𝐖𝐈𝐋𝐋 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐔𝐒 𝐓𝐎 𝐊𝐄𝐄𝐏 𝐎𝐔𝐑 𝐁𝐎𝐓 𝐎𝐍 𝐇𝐄𝐑𝐎𝐊𝐔 𝐀𝐍𝐃 𝐒𝐎 𝐓𝐇𝐀𝐓 𝐖𝐄 𝐂𝐀𝐍 𝐊𝐄𝐄𝐏 𝐔𝐏𝐋𝐎𝐀𝐃𝐈𝐍𝐆 𝐌𝐎𝐕𝐈𝐄𝐒 𝐀𝐍𝐃 𝐖𝐄𝐁𝐒𝐄𝐑𝐈𝐄𝐒 𝐍𝐎𝐍 𝐒𝐓𝐎𝐏 𝐈𝐍 𝐁𝐄𝐒𝐓 𝐐𝐔𝐀𝐋𝐈𝐓𝐈𝐄𝐒.

𝐘𝐎𝐔 𝐂𝐀𝐍 𝐃𝐎𝐍𝐀𝐓𝐄 𝐀𝐍𝐘 𝐀𝐌𝐎𝐔𝐍𝐓 𝐘𝐎𝐔 𝐇𝐀𝐕𝐄 🌝<b>
...
›› ꜱᴛᴇᴘ 4 : ɪꜰ ʏᴏᴜ ᴅᴏɴ'ᴛ ᴜꜱɪɴɢ ᴀɴʏ ꜱʜᴏʀᴛɴᴇʀ ᴡᴇʙꜱɪᴛᴇ ᴛʜᴇɴ ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ꜰɪʀꜱᴛ ᴏɴ <a href=https://arolinks.com/ref/MrReflexer>ᴀʀᴏʟɪɴᴋs</a> (ʏᴏᴜ ᴄᴀɴ ᴀʟꜱᴏ ᴜꜱᴇ ᴏᴛʜᴇʀ ʟɪɴᴋ ꜱʜᴏʀᴛɴᴇʀ ᴡᴇʙꜱɪᴛᴇ).

›› ꜱᴛᴇᴘ 5 : ᴄᴏᴘʏ ʏᴏᴜʀ ᴀᴘɪ ꜰʀᴏᴍ ᴡᴇʙꜱɪᴛᴇ ᴀɴᴅ ᴛʜᴇɴ, ꜱɪᴍᴘʟʏ ꜱᴇᴛ ʏᴏᴜʀ ᴡᴇʙꜱɪᴛᴇ ᴀɴᴅ ᴀᴘɪ ᴜꜱɪɴɢ ᴛʜᴇ /shortlink ᴄᴏᴍᴍᴀɴᴅ.

› ʟɪᴋᴇ ᴛʜɪꜱ :</b>  <code>/shortlink arolinks.com
1f61d49dc2eaa30b7a665dcbb7c1daf27eed1520</code>
...
🌟 Rᴀᴛɪɴɢ : {rating} / 10 (based on {votes} users ratings.)

📀 Rᴜɴᴛɪᴍᴇ : {runtime} Minutes

⏰ Rᴇsᴜʟᴛ sʜᴏᴡᴇᴅ ɪɴ : {remaining_seconds} seconds 🔥

❤ Rᴇᴏ‌ᴜᴇsᴛᴇᴅ ʙʏ : {message.from_user.mention}

========== • ✠ • ==========
⚠ ɪᴍᴅʙ ɪɴꜰᴏ ᴄᴀɴ ʙᴇ ᴡʀᴏɴɢ, ᴘʟᴇᴀsᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜰɪʟᴇs

⚠ ɪᴍᴅʙ की जानकारी गलत हो सकती है कृपया फाइलों की जांच करें |
========== • ✠ • ==========</b>"""
...
‼️ ᴀꜰᴛᴇʀ sᴇɴᴅɪɴɢ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴘʟᴇᴀsᴇ ɢɪᴠᴇ ᴜs sᴏᴍᴇ ᴛɪᴍᴇ ᴛᴏ ᴀᴅᴅ ʏᴏᴜ ɪɴ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ ʟɪsᴛ.</b>"""
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/Mr_Reflexer'>ᴏᴡɴᴇʀ</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
🏆 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='https://t.me/Mr_Reflexer'>ᴏᴡɴᴇʀ</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
...
‼️ ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀꜰᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ.</b>"""
...
🎖️ <u>ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʟᴀɴs</u> 🎖️

● <code>₹10</code> ➛ <u>ʙʀᴏɴᴢᴇ ᴘʟᴀɴ</u> » <code>7 ᴅᴀʏꜱ</code>
● <code>₹20</code> ➛ <u>ꜱɪʟᴠᴇʀ ᴘʟᴀɴ</u> » <code>15 ᴅᴀʏꜱ</code>
● <code>₹40</code> ➛ <u>ɢᴏʟᴅ ᴘʟᴀɴ</u> » <code>30 ᴅᴀʏꜱ</code>
● <code>₹55</code> ➛ <u>ᴘʟᴀᴛɪɴᴜᴍ ᴘʟᴀɴ</u> » <code>45 ᴅᴀʏꜱ</code>
● <code>₹75</code> ➛ <u>ᴅɪᴀᴍᴏɴᴅ ᴘʟᴀɴ</u> » <code>60 ᴅᴀʏꜱ</code>

💵 ᴜᴘɪ ɪᴅ - <code>paytobishal@fam</code>
📸 ǫʀ ᴄᴏᴅᴇ - <a href='https://envs.sh/axg.jpg'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a>

⚜️ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ ʙʏ ᴜꜱɪɴɢ : /myplan

‼️ ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀꜰᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ

⚠ Dɪsᴄʟᴀɪᴍᴇʀ : Iꜰ Aɴʏ Pʀᴏʙʟᴇᴍ Aʀɪsᴇs Dᴜʀɪɴɢ Tʜᴇ Exᴇᴄᴜᴛɪᴏɴ Oꜰ Tʜᴇ Pʟᴀɴ, Tʜᴇɴ  Wᴇ Aʀᴇ Nᴏᴛ Rᴇsᴘᴏɴsɪʙɪʟᴇ.</b>"""    
...
/Instagram  sᴇɴᴅ ɪɴsᴛᴀɢʀᴀᴍ ʀᴇᴇʟ,sᴛᴏʀɪᴇs ᴀɴᴅ ᴘᴏsᴛ ʟɪɴᴋ ᴛᴏ ᴛʜɪs ʙᴏᴛ, ꜰᴏʀ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ, ᴘᴜʙʟɪᴄ ᴏɴʟʏ.
